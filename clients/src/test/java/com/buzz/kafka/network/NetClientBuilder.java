...
public class NetClientBuilder {
    ...
    private void init(Properties properties, String groupId) {
        ...
        LogContext logContext = new LogContext("[Consumer clientId=myTest, groupId=" + groupId + "] ");
        ChannelBuilder channelBuilder = ClientUtils.createChannelBuilder(config, time,logContext);

        FetcherMetricsRegistry metricsRegistry = new FetcherMetricsRegistry(Collections.singleton(CLIENT_ID_METRIC_TAG), "consumer");
